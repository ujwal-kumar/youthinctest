                            ...
                            <div class="control-group clearfix">
                                    ...
                                    <?php
                                        ...
                                        if(!empty($question->gridAnswers))
                                        {
                                            ...
                                            if($survey[0]->Survey_Status == 'Completed')
                                            {
                                                $disabled = ' disabled ';
...
//                                                            echo '</label><br>';
                                                        ...
                                                        foreach($question->surveyTransactions as $surveyTransaction)
                                                        {
...
//                                            prd($question);
//                                            if(!empty($question->surveyTransactions[0]))
//                                            {
//                                                $answers = explode(',', $question->surveyTransactions[0]->Answers);
//                                                echo  Html::input('hidden', 'AnswerOptions[DetailsId]['.$questionId.']', $question->surveyTransactions[0]->SurveyDetail_ID, ['class' => '']) ;
//                                                
//                                            }
...
//                                                    if(!empty($question->surveyTransactions[$ansKey]))
//                                                    {
//                                                        $surveyObj = $question->surveyTransactions[$ansKey];
...
<!--                                                        <label><?php echo $answer->Answer_Name ?></label><br>-->
                                                ...
                                                {
                                                    $selected = '';
//                                                    prd($question->surveyTransactions);
                                                    foreach($question->surveyTransactions as $surveyTransaction)
                                                    {
//                                                        echo $answerId;
...
//                            prd($questionLeft['questions']);
                        ...
                        ?>
                        <?php if(!empty($questionLeft['questions']) && $questionCount == $total && $survey[0]->Survey_Status != 'Completed' ): ?>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="pull-right">
                            ...
                            <?php if($survey[0]->Survey_Status != 'Completed'): ?>
                            <a  class="btn btn-primary svy-save">Save <i class="fa fa-spinner" aria-hidden="true"></i></a>
