...
//                            if (event.keyCode == 190 || event.keyCode == 8 || event.keyCode == 9 || event.keyCode == 27 || event.keyCode == 13 ||
...
//                            }
                ...
                function DivideWithoutPercentage(id1, id2, id3) {
                    ...
                    if ($(id1).text() != "" && $(id1).text().indexOf("$") != 0) {
                        if ($(id2).text() != "" && $(id3).text() != "" && $(id3).text().replace(/[-$\(\)]/g,"") > 0) {
                            $(id1).text((parseInt($(id2).text() == "" ? 0 : $(id2).text().replace(/[-$\(\)]/g,"")) / (parseInt($(id3).text() == "" ? 0 : $(id3).text().replace(/[-$\(\)]/g,"")))).toPrecision(2));
                        }
                    }
                    else {
                        if ($(id2).text() != "" && $(id3).text() != "" && $(id3).text().replace(/[-$\(\)]/g,"") > 0) {
                ...
                function DivideWithoutPercentageandRoundWithTwodecimal(id1, id2, id3) {
                    ...
                    if ($(id1).text() != "" && $(id1).text().indexOf("$") != 0) {
                        ...
                        if ($(id2).text() != "" && $(id3).text() != "" && $(id3).text().replace(/[-$\(\)]/g,"") > 0) {
                            $(id1).text(roundToTwo(parseInt($(id2).text() == "" ? 0 : $(id2).text().replace(/[-$\(\)]/g,"")) / (parseInt($(id3).text() == "" ? 0 : $(id3).text().replace(/[-$\(\)]/g,"")))));
                        }
                    }
