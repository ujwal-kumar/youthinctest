...
$(document).ready(function(){
    $('body').on('click', '.check-all',function(){
        ...
        if(this.checked){
            $(this).parents(".panel").find(".panel-body").find('.ace').each(function(){
                this.checked = true;
            });
        }else{
            $(this).parents(".panel").find(".panel-body").find('.ace').each(function(){
    ...
    $('body').on('click', '.ace',function(){
        if($('.ace:checked').length == $('.ace').length){
            $(this).parents(".panel").find(".panel-heading").find('.check-all').prop('checked',true);
        }else{
            $(this).parents(".panel").find(".panel-heading").find('.check-all').prop('checked',false);
        }
    });
});
